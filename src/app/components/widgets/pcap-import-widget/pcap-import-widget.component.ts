...
fileProcessor(e){
    ...
    case 1:
      ...
      var blob = this.file.slice( this.fileposition, this.fileposition + incl_len );
    ...
    case 2:
      ...
      if ( parseInt( etherpacket.ethertype, 16 ) > 1536 )
      {
        ...
        case "0800":
          ...
          etherpacket.ipv4.version = parseInt( this.toHex( ( etherpacket.ipv4.data[ 0 ] >> 4 ) & 0xf ), 16 );
          etherpacket.ipv4.ihl = parseInt( this.toHex( etherpacket.ipv4.data[ 0 ] & 0xf ), 16 );
          etherpacket.ipv4.dscp = this.toHex( ( etherpacket.ipv4.data[ 1 ] >> 2 ) & 0x3f );
          etherpacket.ipv4.ecn = this.toHex( etherpacket.ipv4.data[ 1 ] & 0x3 );
          etherpacket.ipv4.totallength = parseInt( this.toHex( etherpacket.ipv4.data[ 2 ] ) + this.toHex( etherpacket.ipv4.data[ 3 ] ), 16 );
          etherpacket.ipv4.identification = parseInt( this.toHex( etherpacket.ipv4.data[ 4 ] ) + this.toHex( etherpacket.ipv4.data[ 5 ] ), 16 );
          etherpacket.ipv4.flags = this.toHex( ( etherpacket.ipv4.data[ 6 ] >> 5 ) & 7 );
          etherpacket.ipv4.fragmentoffset = "" + this.toHex( etherpacket.ipv4.data[ 6 ] & 0x1f ) + this.toHex( etherpacket.ipv4.data[ 7 ] );
          etherpacket.ipv4.ttl = etherpacket.ipv4.data[ 8 ];
          etherpacket.ipv4.protocol = etherpacket.ipv4.data[ 9 ];
          etherpacket.ipv4.checksum = "" + this.toHex( etherpacket.ipv4.data[ 10 ] ) + this.toHex( etherpacket.ipv4.data[ 11 ] );
          ...
          var hostid = -1;
          if ( -1 == ( hostid = this.ipv4hosts.indexOf( etherpacket.ipv4.src ) ) )
          {
          ...
          if ( -1 == ( hostid = this.ipv4hosts.indexOf( etherpacket.ipv4.dst ) ) )
          {
          ...
          case 17:
            ...
            etherpacket.ipv4.udp.srcport = parseInt( this.toHex( etherpacket.ipv4.data[ 20 ] ) + this.toHex( etherpacket.ipv4.data[ 21 ] ), 16 );
            etherpacket.ipv4.udp.dstport = parseInt( this.toHex( etherpacket.ipv4.data[ 22 ] ) + this.toHex( etherpacket.ipv4.data[ 23 ] ), 16 );
            etherpacket.ipv4.udp.length = parseInt( this.toHex( etherpacket.ipv4.data[ 24 ] ) + this.toHex( etherpacket.ipv4.data[ 25 ] ), 16 );
            etherpacket.ipv4.udp.checksum = parseInt( this.toHex( etherpacket.ipv4.data[ 26 ] ) + this.toHex( etherpacket.ipv4.data[ 27 ] ), 16 );
            etherpacket.ipv4.udp.data = etherpacket.ipv4.data.slice( 28, etherpacket.ipv4.data.length );
            break;
          case 6:
            /* TCP */
            etherpacket.ipv4.tcp = {};
            etherpacket.ipv4.tcp.srcport = parseInt( this.toHex( etherpacket.ipv4.data[ 20 ] ) + this.toHex( etherpacket.ipv4.data[ 21 ] ), 16 );
            etherpacket.ipv4.tcp.dstport = parseInt( this.toHex( etherpacket.ipv4.data[ 22 ] ) + this.toHex( etherpacket.ipv4.data[ 23 ] ), 16 );
            etherpacket.ipv4.tcp.sequencenumber = parseInt( this.toHex( etherpacket.ipv4.data[ 24 ] ) + this.toHex( etherpacket.ipv4.data[ 25 ] ) + this.toHex( etherpacket.ipv4.data[ 26 ] ) + this.toHex( etherpacket.ipv4.data[ 27 ] ), 16 );
            etherpacket.ipv4.tcp.acknowledgmentnumber = parseInt( this.toHex( etherpacket.ipv4.data[ 28 ] ) + this.toHex( etherpacket.ipv4.data[ 29 ] ) + this.toHex( etherpacket.ipv4.data[ 30 ] ) + this.toHex( etherpacket.ipv4.data[ 31 ] ), 16 );
            ...
            etherpacket.ipv4.tcp.windowsize = parseInt( this.toHex( etherpacket.ipv4.data[ 34 ] ) + this.toHex( etherpacket.ipv4.data[ 35 ] ), 16 );
            etherpacket.ipv4.tcp.checksum = parseInt( this.toHex( etherpacket.ipv4.data[ 36 ] ) + this.toHex( etherpacket.ipv4.data[ 37 ] ), 16 );
            etherpacket.ipv4.tcp.urgentpointer = parseInt( this.toHex( etherpacket.ipv4.data[ 38 ] ) + this.toHex( etherpacket.ipv4.data[ 39 ] ), 16 );
